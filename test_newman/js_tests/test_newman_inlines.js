...
/*nosejs.requireFile("../../../newman/media/jquery/jquery-1.3.2.js");
nosejs.requireFile("../../../newman/media/jquery/jquery-ui.js");
nosejs.requireResource("jquery/qunit-testrunner.js");

nosejs.requireFile("../../../newman/media/js/inlines.js");*/
if (typeof nosejs !== "undefined") {
    nosejs.requireResource("jquery-1.3.1.js");
    nosejs.requireResource("jquery/qunit-testrunner.js");
    nosejs.requireFile("case.js"); //TestCase namespace definition

    nosejs.requireFile("../../../newman/media/js/kobayashi.js");
    nosejs.requireFile("../../../newman/media/js/newman.js");
    nosejs.requireFile("../../../newman/media/js/inlines.js");
}
////////////////////////
