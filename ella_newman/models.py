...
from ella_two_ports.cache.utils import CachedForeignKey
from ella.core.models import Category
from ella_newman.managers import DenormalizedCategoryUserRoleManager
...
class CategoryUserRole(models.Model):
    ...
    def sync_denormalized(self):
        from ella_newman.permission import compute_applicable_categories_objects
        denormalized = []
        cats = []
